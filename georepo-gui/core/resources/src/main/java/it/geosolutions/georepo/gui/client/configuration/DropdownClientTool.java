/*
 * $ Header: it.geosolutions.georepo.gui.client.configuration.DropdownClientTool,v. 0.1 3-gen-2011 17.06.10 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
