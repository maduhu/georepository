/*
 * $ Header: it.geosolutions.georepo.gui.client.model.data.Grant,v. 0.1 31-gen-2011 10.57.25 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
 ...
 * The Class Grant.
 */
public class Grant extends BeanModel {
    ...
    public Grant() {
        super();
        setPath("georepo/resources/images/grant.jpg");
    }
