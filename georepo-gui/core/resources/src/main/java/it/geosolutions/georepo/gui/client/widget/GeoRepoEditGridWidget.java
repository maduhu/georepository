/*
 * $ Header: it.geosolutions.georepo.gui.client.widget.GeoRepoGridWidget,v. 0.1 25-gen-2011 11.24.44 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
/**
 * The Class GeoRepoGridWidget.
 * 
 * @param <T>
 *            the generic type
 */
public abstract class GeoRepoEditGridWidget<T extends BaseModel>  extends GeoRepoFormWidget{
     ...
     *            the models
     */
    public GeoRepoEditGridWidget(List<T> models) {
        createStore();
