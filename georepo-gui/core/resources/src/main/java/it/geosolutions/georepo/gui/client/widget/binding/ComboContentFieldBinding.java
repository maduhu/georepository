/*
 * $ Header: it.geosolutions.georepo.gui.client.widget.binding.ComboContentFieldBinding,v. 0.1 3-gen-2011 17.06.11 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
/**
 * The Class ComboContentFieldBinding.
 */
public class ComboContentFieldBinding extends FieldBinding {
    ...
    /**
     * Instantiates a new combo content field binding.
     * 
     * @param field
     *            the field
     * @param property
    ...
    public void updateField(boolean updateOriginalValue) {
        ...
        ((ComboBox<ContentType>) field).setValue(new ContentType(val.toString()));

        if (updateOriginalValue) {
            ((ComboBox<ContentType>) field).setOriginalValue(new ContentType(val.toString()));
        }
    }
    ...
    public void resetValue() {
        ...
        ((ComboBox<ContentType>) field).setValue(new ContentType(oldValue.toString()));
