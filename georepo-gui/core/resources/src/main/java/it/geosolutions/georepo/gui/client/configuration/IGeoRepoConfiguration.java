/*
 * $ Header: it.geosolutions.georepo.gui.client.configuration.IGeoRepoConfiguration,v. 0.1 14-gen-2011 19.29.22 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
/**
 * The Interface IGeoRepoConfiguration.
 */
