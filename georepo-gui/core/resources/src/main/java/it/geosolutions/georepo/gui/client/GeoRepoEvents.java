...
public class GeoRepoEvents {
    ...
    /** The Constant INIT_GEOREPO_WIDGET. */
    public static final EventType INIT_GEOREPO_WIDGET = new EventType();
    ...
    /** The Constant INIT_GEOREPO_MAIN_UI. */
    public static final EventType INIT_GEOREPO_MAIN_UI = new EventType();
