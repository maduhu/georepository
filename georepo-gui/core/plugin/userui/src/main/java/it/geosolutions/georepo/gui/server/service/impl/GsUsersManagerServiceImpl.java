...
public class GsUsersManagerServiceImpl implements IGsUsersManagerService
{
    ...
    public PagingLoadResult<GSUser> getGsUsers(int offset, int limit, boolean full) throws ApplicationException
    {
        ...
        List<ShortUser> usersList = georepoRemoteService.getUserAdminService().getList(null, page, limit);
     ...
     */
    private void copyUser(GSUser user, it.geosolutions.georepo.core.model.GSUser remote_user) throws NotFoundServiceEx
    {
