...
//	}
//
//	public Collection<GrantedAuthority> attemptAuthentication(String username, String password) throws Exception {
//		/**
//		 * Spring Security
//		 */
//		/*AuthenticationManager am = (AuthenticationManager) ctx.getBean("OpenSDIAuthenticationManager");
//		
//		try {
...
//				LOGGER.info("Checking role " + role.getName().toUpperCase() + " for member " + member.getUsername());
