...
public class RuleLimitsWidget extends ContentPanel {
     ...
     *            the rule service
     */
    public RuleLimitsWidget(Rule model, RulesManagerServiceRemoteAsync rulesService) {
        this.theRule = model;
        ...
        saveLayerDetailsButton.addListener(Events.OnClick, new Listener<ButtonEvent>() {
        	...
        	public void handleEvent(ButtonEvent be) {
        		...
        		Dispatcher.forwardEvent(GeoRepoEvents.SAVE_LAYER_LIMITS, limitsInfoModel);

        		Dispatcher.forwardEvent(GeoRepoEvents.SEND_INFO_MESSAGE, new String[] {
        				"GeoServer Rules: Layer Limits", "Apply Changes" }); 
