/*
 * $ Header: it.geosolutions.georepo.gui.client.widget.SearchPagMemberWidget,v. 0.1 3-gen-2011 17.06.53 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
public class SearchPagMemberWidget extends DGWATCHSearchWidget<Member> {
    ...
    /**
     * Instantiates a new search pag member widget.
     * 
     * @param service
     *            the service
     */
    ...
    public void createStore() {
        ...
        this.proxy = new RpcProxy<PagingLoadResult<Member>>() {
            ...
            protected void load(Object loadConfig, AsyncCallback<PagingLoadResult<Member>> callback) {
                ...
                service.loadMembers((PagingLoadConfig) loadConfig, searchText, callback);
            }
        };
