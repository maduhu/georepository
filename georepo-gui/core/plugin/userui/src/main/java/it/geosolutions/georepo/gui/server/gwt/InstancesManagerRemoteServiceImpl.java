...
import it.geosolutions.georepo.gui.client.service.InstancesManagerRemoteService;
...
public class InstancesManagerRemoteServiceImpl extends RemoteServiceServlet implements InstancesManagerRemoteService
{
     ...
     *
     * @see
     * it.geosolutions.georepo.gui.client.service.InstancesManagerRemoteService#getInstances(com.extjs
    ...
    /* (non-Javadoc)
     * @see it.geosolutions.georepo.gui.client.service.InstancesManagerRemoteService#deleteInstance(it.geosolutions.georepo.gui.client.model.Instance)
     */
    ...
    /* (non-Javadoc)
     * @see it.geosolutions.georepo.gui.client.service.InstancesManagerRemoteService#saveInstance(it.geosolutions.georepo.gui.client.model.Instance)
     */
