/*
 * $ Header: it.geosolutions.georepo.gui.client.widget.rule.detail.LayerAttributesTabItem,v. 0.1 25-feb-2011 16.30.38 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
