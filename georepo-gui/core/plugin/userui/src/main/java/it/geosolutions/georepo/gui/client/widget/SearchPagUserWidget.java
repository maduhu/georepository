/*
 * $ Header: it.geosolutions.georepo.gui.client.widget.SearchPagUserWidget,v. 0.1 14-gen-2011 19.29.52 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
public class SearchPagUserWidget extends GeoRepoSearchWidget<User> {
    ...
    public void select() {
        ...
        Dispatcher.forwardEvent(GeoRepoEvents.BIND_SELECTED_USER, grid.getSelectionModel()
                .getSelectedItem());
    }
