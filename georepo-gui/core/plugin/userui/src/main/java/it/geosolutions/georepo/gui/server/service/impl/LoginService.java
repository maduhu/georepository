...
public class LoginService implements ILoginService {
	 ...
	 * 
	 * @see
	 * it.geosolutions.georepo.gui.server.service.ILoginService#authenticate
	...
	public User authenticate(String userName, String password,
		...
		try {
			URL url = Class.forName(
					"it.geosolutions.georepo.gui.client.UserUI").getResource(
					"client.keystore");
...
//			grantedAuthorities =
        ...
        if (grantedAuths != null
				&& !grantedAuths.getAuthorities().isEmpty()) {
		}
