/*
 * $ Header: it.geosolutions.georepo.gui.client.configuration.WorkspaceConfigOpts,v. 0.1 07-gen-2012 16.27.48 created by Tobia Di Pisa <tobia.dipisa at geo-solutions.it> $
 * $ Revision: 0.1 $
