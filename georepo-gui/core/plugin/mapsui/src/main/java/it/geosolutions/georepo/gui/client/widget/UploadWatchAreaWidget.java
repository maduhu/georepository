/*
 * $ Header: it.geosolutions.georepo.gui.client.widget.UploadWatchAreaWidget,v. 0.1 14-gen-2011 19.28.38 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
/**
 * The Class UploadWatchAreaWidget.
 */
public class UploadWatchAreaWidget extends Dialog {
    ...
    /** The map preview widget. */
    private MapPreviewWidget mapPreviewWidget;

    /** The Constant UPLOAD_ACTION_URL. */
    private static final String UPLOAD_ACTION_URL = GWT.getModuleBaseURL() + "upload";

    /**
     * Instantiates a new upload watch area widget.
     */
    ...
    private void createUpload() {
        ...
        panel.add(new Button("Submit", new SelectionListener<ButtonEvent>() {
            ...
            public void componentSelected(ButtonEvent ce) {
                formPanel.submit();
                if ((upload.getFilename() != null) && (upload.getFilename().endsWith("zip")))
            ...
            public void onSubmitComplete(SubmitCompleteEvent event) {
                ...
                if ((wkt != null) && !(wkt.length() == 0)) {
                    ...
                    if (wkt.contains("Error : ")) {
                        MessageBox.alert("Alert", wkt, new Listener<MessageBoxEvent>() {
                    ...
                    setSaveStatus(EnumSaveStatus.STATUS_SAVE, EnumSaveStatus.STATUS_MESSAGE_SAVE);
                } else
    ...
    protected void createButtons() {
        ...
        this.done = new Button("Done", new SelectionListener<ButtonEvent>() {
            ...
            public void componentSelected(ButtonEvent ce) {
                hide();
                Dispatcher.forwardEvent(GeoRepoEvents.INJECT_WKT_FROM_SHP, wkt);
            }
        });
