/*
 * $ Header: it.geosolutions.georepo.gui.client.action.toolbar.ZoomInAction,v. 0.1 25-gen-2011 11.30.32 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
public class ZoomInAction extends ToolbarMapAction {
    ...
    public ZoomInAction(MapWidget mapWidget) {
        super(I18nProvider.getMessages().zoomInToolTip(), Category.GEOREPO_ZOOM_IN);
