/*
 * $ Header: it.geosolutions.georepo.gui.client.widget.binding.filtervalue.CloudCoverFieldBinding,v. 0.1 14-gen-2011 19.28.38 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
/**
 * The Class CloudCoverFieldBinding.
 */
public class CloudCoverFieldBinding extends FieldBinding implements IFilterFieldBinding {

    /** The old value. */
    private Object oldValue;

    /**
     * Instantiates a new cloud cover field binding.
     * 
     * @param field
     *            the field
     * @param property
