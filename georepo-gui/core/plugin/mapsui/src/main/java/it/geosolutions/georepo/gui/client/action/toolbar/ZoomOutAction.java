/*
 * $ Header: it.geosolutions.georepo.gui.client.action.toolbar.ZoomOutAction,v. 0.1 14-gen-2011 19.28.38 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
public class ZoomOutAction extends ToolbarMapAction {
    ...
    public ZoomOutAction(MapWidget mapWidget) {
        super(I18nProvider.getMessages().zoomOutToolTip(), Category.GEOREPO_ZOOM_OUT);
