 ...
 */
public class GeoConstraintBindingWidget extends GeoRepoBindingWidget<GeoConstraint> {
    ...
    public FormPanel createFormPanel() {
        ...
        this.addGeoConstraint = new Button(I18nProvider.getMessages().aoiNew(),
                new SelectionListener<ButtonEvent>() {
                    ...
                    public void componentSelected(ButtonEvent ce) {
                        ...
                        Dispatcher.forwardEvent(GeoRepoEvents.SHOW_ADD_GEOCONSTRAINT);
                    }
                });
                ...
                MessageBox.confirm("Delete GeoConstraint", "Are you sure to delete GeoConstraint "
                    ...
                    public void handleEvent(MessageBoxEvent be) {
                        ...
                        if (btn.getText().equalsIgnoreCase("YES"))
                            Dispatcher.forwardEvent(GeoRepoEvents.DELETE_GEOCONSTRAINT, getModel());
                    }
                });
            }
        });
        ...
        this.searchGeoConstraint = new Button(I18nProvider.getMessages().aoiSearch(),
                new SelectionListener<ButtonEvent>() {
                    ...
                    @Override
                    public void componentSelected(ButtonEvent ce) {
                        Dispatcher.forwardEvent(GeoRepoEvents.SEARCH_GEOCONSTRAINT);
                    }
                });
