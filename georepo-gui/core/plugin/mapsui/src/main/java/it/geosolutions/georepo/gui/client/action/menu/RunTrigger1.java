/*
 * $ Header: it.geosolutions.georepo.gui.client.action.menu.RunTrigger1,v. 0.1 14-gen-2011 19.28.37 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
public class RunTrigger1 extends MenuAction {
    ...
    public void componentSelected(MenuEvent ce) {
        ...
        Dispatcher.forwardEvent(GeoRepoEvents.QUARTZ_TRIGGER, new Integer(1));
    }
