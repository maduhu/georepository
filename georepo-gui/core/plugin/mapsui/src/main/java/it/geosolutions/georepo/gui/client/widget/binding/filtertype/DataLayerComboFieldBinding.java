/*
 * $ Header: it.geosolutions.georepo.gui.client.widget.binding.filtertype.DataLayerComboFieldBinding,v. 0.1 14-gen-2011 19.28.37 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
/**
 * The Class DataLayerComboFieldBinding.
 */
public class DataLayerComboFieldBinding extends FieldBinding implements IFilterFieldBinding {

    /** The old value. */
    private Object oldValue;

    /**
     * Instantiates a new data layer combo field binding.
     * 
     * @param field
     *            the field
     * @param property
