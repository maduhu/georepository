/*
 * $ Header: it.geosolutions.georepo.gui.client.widget.binding.filtertype.DataLayerComboFieldBinding,v. 0.1 3-gen-2011 16.53.35 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
