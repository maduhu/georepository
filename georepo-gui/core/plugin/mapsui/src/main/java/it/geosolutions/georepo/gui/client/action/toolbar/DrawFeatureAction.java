/*
 * $ Header: it.geosolutions.georepo.gui.client.action.toolbar.DrawFeatureAction,v. 0.1 25-gen-2011 11.30.32 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
