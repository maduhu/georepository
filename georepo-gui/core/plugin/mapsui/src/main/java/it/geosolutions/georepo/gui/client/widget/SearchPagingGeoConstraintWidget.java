 ...
 */
public class SearchPagingGeoConstraintWidget extends GeoRepoSearchWidget<GeoConstraint> {
    ...
    public void select() {
        ...
        Dispatcher.forwardEvent(GeoRepoEvents.BIND_SELECTED_GEOCONSTRAINT, grid.getSelectionModel()
                .getSelectedItem());
    }
