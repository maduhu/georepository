 ...
 */
public class AOIShareWidget extends GeoRepoBindingWidget<AOI> {
    ...
    public FormPanel createFormPanel() {
        ...
        shareAOI = new Button("Share", new SelectionListener<ButtonEvent>() {
            ...
            public void componentSelected(ButtonEvent ce) {
                ...
                Dispatcher.forwardEvent(GeoRepoEvents.SHARE_AOI);
            }
        });
        ...
        unshareAOI = new Button("Unshare", new SelectionListener<ButtonEvent>() {
            ...
            public void componentSelected(ButtonEvent ce) {
                ...
                Dispatcher.forwardEvent(GeoRepoEvents.SHOW_CHOOSER_USER_WIDGET);

            }
        });

        unshareAOI.setWidth(100);
        unshareAOI.setIconStyle("x-georepo-unshare");
