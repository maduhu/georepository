/*
 * $ Header: it.geosolutions.georepo.gui.client.configuration.AdministrationModeClientTool,v. 0.1 14-gen-2011 19.28.37 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
