/*
 * $ Header: it.geosolutions.georepo.gui.client.action.toolbar.CleanDgWatchMenu,v. 0.1 14-gen-2011 19.28.38 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
