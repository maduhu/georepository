 ...
 */
public class GeoConstraintPaginationGridWidget extends GeoRepoGridWidget<GeoConstraint> {
    ...
    public void setGridProperties() {
        ...
        this.grid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
            ...
            public void handleEvent(BaseEvent be) {
                Dispatcher.forwardEvent(GeoRepoEvents.BIND_SELECTED_GEOCONSTRAINT, grid
