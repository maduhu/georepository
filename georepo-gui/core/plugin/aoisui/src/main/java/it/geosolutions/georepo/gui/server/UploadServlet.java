/*
 x * $Header: it.geosolutions.georepo.gui.server.UploadServlet,v. 0.1 17/lug/2010 16.53.09 created by giuseppe $
 * $Revision: 0.1 $
...
public class UploadServlet extends HttpServlet {
	...
	private String calculateWKT(File file) throws Exception {
		...
		File shpDir = null;
		try {
			shpDir = DGWATCHIoUtility.decompress("DGWATCH", file,
