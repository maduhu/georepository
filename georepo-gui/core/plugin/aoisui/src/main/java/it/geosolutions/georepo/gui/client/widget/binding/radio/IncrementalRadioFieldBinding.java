/*
 * $ Header: it.geosolutions.georepo.gui.client.widget.binding.radio.IncrementalRadioFieldBinding,v. 0.1 3-gen-2011 16.53.59 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
