/*
 * $ Header: it.geosolutions.georepo.gui.client.configuration.AdministrationModeClientTool,v. 0.1 3-gen-2011 16.52.25 created by afabiani <alessio.fabiani at geo-solutions.it> $
 * $ Revision: 0.1 $
...
public class AdministrationModeClientTool extends DropdownClientTool implements Listener<AppEvent> {
    ...
    public void injectSecurity(ComboBox combo, List<Authorization> auths) {
        ...
        if (changeSelectedItem) {
            ...
            Dispatcher.forwardEvent(DGWATCHEvents.ADMIN_MODE_CHANGE, AdministrationMode
