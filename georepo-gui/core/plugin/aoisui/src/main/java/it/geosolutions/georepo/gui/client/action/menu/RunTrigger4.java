/*
 * $Header: it.geosolutions.georepo.gui.client.action.menu.RunTrigger4,v. 0.1 30/set/2010 17.07.19 created by giuseppe $
 * $Revision: 0.1 $
 * $Date: 30/set/2010 17.07.19 $
 *
 * ====================================================================
 *
...
public class RunTrigger4 extends MenuAction {
	...
	public void componentSelected(MenuEvent ce) {
		...
		Dispatcher.forwardEvent(DGWATCHEvents.QUARTZ_TRIGGER, new Integer(4));
	}
