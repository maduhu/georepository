    ...
    public void setGridProperties() {
        ...
        grid.addListener(Events.CellDoubleClick, new Listener<BaseEvent>() {
            ...
            public void handleEvent(BaseEvent be) {
                Dispatcher.forwardEvent(DGWATCHEvents.BINDING_WATCH_WIDGET, grid
                ...
                GridWatchButton trigger = new GridWatchButton("Trigger",
                        new SelectionListener<ButtonEvent>() {
                            ...
                            public void componentSelected(ButtonEvent ce) {
                                ...
                                Dispatcher.forwardEvent(DGWATCHEvents.TRIGGER_WATCH, triggerButton
                                        .getClientShortWatch());
                            }
