...
public class WatchesInfoBindingWidget extends DGWATCHFormBindingWidget<Watch> {
    ...
    private void init() {
        ...
        formBinding = new DGWATCHWatchFormBinding(formPanel, true);
    }
    ...
    public FormPanel createFormPanel() {
        ...
        this.storeRetrieval.add(DGWATCHData.getRetrievalType());
        ...
        deleteMail.setIconStyle("x-dgwatch-delete");
        deleteMail.disable();
        ...
        addMail.setWidth(20);
        addMail.setIconStyle("x-dgwatch-add");
        ...
        modifyMail.setIconStyle("x-dgwatch-edit");
        modifyMail.disable();
        ...
        this.storeContent.add(DGWATCHData.getContentTypes());
        ...
        distStoreContent.add(DGWATCHData.getDistribContentTypes());
        ...
        distStoreTimes.add(DGWATCHData.getDistribTimes());
    ...
    public void bindModel(Watch watch) {
        ...
        if (watch.getFilter() != null)
            Dispatcher.forwardEvent(DGWATCHEvents.EXIST_DEFAULT_FILTER, watch.getFilter());
        else {
            Dispatcher.forwardEvent(DGWATCHEvents.UPDATE_TITLE);
        }
    }
