...
/**
 * A User that can access GeoRepository.
 *
 */
@Entity(name = "GRUser")
...
public class GRUser implements Identifiable, Serializable {
    ...
    /** Is the GRUser Enabled or not in the system? */
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof GRUser)) {
            return false;
        }
        GRUser other = (GRUser) obj;
