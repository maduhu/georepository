 ...
 */
@Entity(name = "StylePermission")
@Table(name = "gr_perm_style")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "StylePermission")
@XmlRootElement(name = "StylePermission")
public class StylePermission {
    ...
    @ForeignKey(name="fk_style_layer")
