...
/* grant select on dg_feature to dgwatch;
grant select on dg_user to dgwatch;
grant select on dg_aoi to dgwatch;
grant select on dg_aoi_user_preference to dgwatch;
...
grant insert,update,delete,select on dg_feature to geosolutions;
grant insert,update,delete,select on dg_user to geosolutions;
grant insert,update,delete,select on dg_aoi to geosolutions;
grant insert,update,delete,select on dg_aoi_user_preference to geosolutions;

grant select,update on dg_feature_seq to geosolutions;
grant select,update on dg_user_seq to geosolutions;
grant select,update on dg_aoi_seq to geosolutions;

grant execute on function fixsequences() to geosolutions;
grant execute on function getlookupid(character varying, character varying) to geosolutions;