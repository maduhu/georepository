...
public class WGFuncServiceImpl implements WebGisFuncService {
    ...
    @Override
    public String getProperty(String profileName, String property) throws BadRequestServiceEx, InternalErrorServiceEx, NotFoundServiceEx {
        if(property == null)
    ...
    @Override
    public List<WebGisProperty> getProfileProperties(String profileName) throws BadRequestServiceEx, InternalErrorServiceEx, NotFoundServiceEx {
        Profile profile = getProfile(profileName);
        Map<String, String> customProps = profileDAO.getCustomProps(profile.getId());
    ...
    protected Profile getProfile(String profileName) throws InternalErrorServiceEx, BadRequestServiceEx, NotFoundServiceEx {
        if (profileName == null) {
        ...
        switch (profiles.size()) {
            ...
            case 1:
                ...
                break;
            default:
                throw new InternalErrorServiceEx("Too many profiles found (name:" + profileName + " #" + profiles.size() + ")");
        }
        return profile;
    }
